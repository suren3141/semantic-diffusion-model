...
# Training
export OPENAI_LOGDIR='/mnt/dataset/semantic-diffusion-model/dsb2018-SDM-128CH' \
mpiexec -n 1 python image_train.py --data_dir /mnt/dataset/dsb2018 --dataset_mode dsb2018 --lr 1e-4 --batch_size 4 --attention_resolutions 32,16,8 --diffusion_steps 1000 --image_size 256 --learn_sigma True \
	     --noise_schedule linear --num_channels 128 --num_head_channels 64 --num_res_blocks 2 --resblock_updown True --use_fp16 True --use_scale_shift_norm True --use_checkpoint True --num_classes 2 \
