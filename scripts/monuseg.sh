...
# Training
export DATA_DIR='/mnt/dataset/MoNuSeg/dataset'
export OPENAI_LOGDIR='/mnt/dataset/semantic-diffusion-model/monuseg'
mpiexec -n 8 python image_train.py --data_dir /mnt/dataset/MoNuSeg/dataset --dataset_mode monuseg --lr 1e-4 --batch_size 4 --attention_resolutions 32,16,8 --diffusion_steps 1000 --image_size 256 --learn_sigma True \
	     --noise_schedule linear --num_channels 256 --num_head_channels 64 --num_res_blocks 2 --resblock_updown True --use_fp16 True --use_scale_shift_norm True --use_checkpoint True --num_classes 2 \
